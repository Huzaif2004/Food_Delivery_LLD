...
public class InMemoryPaymentRepository implements PaymentRepository{
	...
	@Override
	public Optional<Payment> findByOrderIdAndPaymentStatus(String orderId, PaymentStatus status) {
		// TODO Auto-generated method stub
		return payments.values().stream().filter(p->p.getOrderId().equals(orderId)).filter(p->p.getPaymentStatus()==status).findFirst();
